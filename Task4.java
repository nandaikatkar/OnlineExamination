...
// This Java program implements a basic login system and an online test with a timer
//  using Swing for the graphical user interface. The login class creates a login form 
//  with text fields for username and password and a button to submit the login information. 
//  Upon successful login, the OnlineTestBegin class initiates a multiple-choice test with a timer 
//  that counts down from 600 seconds (10 minutes). The test displays questions and multiple-choice
//   answers, allowing users to save answers or mark them for review, and calculates the score at the 
//   end. The main class, Task4, initializes and displays the login form, handling exceptions with
//    a message dialog.
import javax.swing.*;  
import java.awt.*;  
